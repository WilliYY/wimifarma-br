...
- Riscos/cuidados: o video principal continua em autoplay e loop por decisao visual, mas inicia apos um atraso curto para nao disputar a primeira pintura e permanece parado quando o navegador pede movimento reduzido; futuras trocas do arquivo devem preservar o poster leve e revisar a politica de cache. Paginas de conta, carrinho e checkout continuam com `noindex`.
