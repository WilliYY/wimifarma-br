...
export function InstitutionalHero({ title, headline, description, image, imageAlt, imageMode = "panorama", children }: InstitutionalHeroProps) {
  return (
    <section className={styles.section}>
      <div className={cn(styles.hero, imageMode === "portrait" && styles.heroPortrait)}>
        <div className={cn(styles.photo, imageMode === "portrait" && styles.portrait)}>
          <Image alt={imageAlt} className={styles.image} fill priority sizes={imageMode === "portrait" ? "(min-width: 640px) 50vw, 100vw" : "100vw"} src={image} />
